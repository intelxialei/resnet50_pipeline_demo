...
PARSER = argparse.ArgumentParser(
    ...
    description='Resnet50v2 for TensorFlow 2.x',
...
RUNTIME_GROUP.add_argument(
    ...
    type=str,
    metavar='FILE',
    help='Pretrained pb for resnet50v2'
)
...
RUNTIME_GROUP.add_argument(
    '--async_inference',
    action='store_true',
    help='run inference in async model'
)
...
RUNTIME_GROUP.add_argument(
    ...
    default=0,
    help=(
        'One of supported preprocessing modes:'
        '\n\t0 - using python list'
